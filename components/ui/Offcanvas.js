  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`offcanvas rounded-tr-3xl flex flex-col bg-light dark:bg-dark w-full h-screen border-r border-t dark:border-r-dark dark:border-t-dark select-none pt-7 ${className}`}
      >
        {children}
      </motion.div>
    </div>
